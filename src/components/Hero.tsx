export default function Hero() {
  return (
    <div className="flex flex-col items-center gap-12 pt-18 px-2 pb-4 bg-accent-1">
      <div className="flex flex-col items-center gap-4">
        ...
        <p className="text-center text-md text-neutral-11">
          Modern, conversion-focused websites that turn visitors into customers.
        </p>
        <div className="w-full">
          <button className="w-full py-3 bg-accent-9 font-bold rounded-md text-accent-contrast hover:bg-accent-10">
            Book A Free Call
          </button>
        </div>
      </div>
